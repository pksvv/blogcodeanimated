const skills = [
  ...
  export default function Skills() {
    return (
      <div className="py-16 bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
        {/* Tech Stack Section */}
        ...
        <div className="mt-8 px-6 space-y-8 max-w-4xl mx-auto">
          {experience.map((role, index) => (
            <div
              key={index}
              className="rounded-lg border border-gray-300 dark:border-gray-700 p-6 shadow-md 
